...
import com.xcvi.micros.ui.feature_food.FoodSummaryCard
...
fun FoodScreen(
    ...
    topAppBarTitle: String = stringResource(R.string.food_log_app_bar_title),
    ...
    val gotoSearch = { mealCard: MealCard ->
    ...
    val gotoMeal = { mealCard: MealCard ->
        navController.navigate(
            FoodGraph.Meal(
                meal = mealCard.meal,
                date = state.currentDate
