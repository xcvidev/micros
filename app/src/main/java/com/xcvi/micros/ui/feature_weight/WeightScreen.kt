...
fun WeightScreen(
    ...
    topAppBarTitle: String = stringResource(R.string.weight_manager),
    deleteDialogTitle: String = stringResource(R.string.delete),
    deleteDialogText : String= stringResource(R.string.delete_confirm_text),
    noWeightsText: String = stringResource(R.string.no_weights_measured_this_week),
    deleteDialogButtonText: String = stringResource(R.string.delete),
